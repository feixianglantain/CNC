...
//  #define STEP_MASK       ((1<<X_STEP_BIT)|(1<<Y_STEP_BIT)|(1<<Z_STEP_BIT)) // All step bits
  ...
  #define Y_STEP_PORT      GPIOA->ODR
  #define Z_STEP_PORT      GPIOA->ODR
  #define X_STEP_BIT       0  // PA0
  #define Y_STEP_BIT       1  // PA1
  #define Z_STEP_BIT       2  // PA2
...
//  #define DIRECTION_MASK    ((1<<X_DIRECTION_BIT)|(1<<Y_DIRECTION_BIT)|(1<<Z_DIRECTION_BIT)) // All direction bits
  ...
  #define Z_DIRECTION_PORT   GPIOA->ODR
  #define X_DIRECTION_BIT    3  // PA3
  #define Y_DIRECTION_BIT    4  // PA4
  #define Z_DIRECTION_BIT    5  // PA5
...
//  #define STEPPERS_DISABLE_MASK   (1<<STEPPERS_DISABLE_BIT)
  ...
  #define X_STEP_EN_PORT   GPIOA->ODR
  #define Y_STEP_EN_PORT   GPIOA->ODR
  #define Z_STEP_EN_PORT   GPIOA->ODR
  #define X_STEP_EN_BIT    6  // PA6
  #define Y_STEP_EN_BIT    7  // PA7
  #define Z_STEP_EN_BIT    8  // PA8
  
  #define X_STEP_EN        X_STEP_EN_PORT |= (1 << X_STEP_EN_BIT)
  #define X_STEP_DIS       X_STEP_EN_PORT &= ~(1 << X_STEP_EN_BIT)
  #define Y_STEP_EN        Y_STEP_EN_PORT |= (1 << Y_STEP_EN_BIT)
  #define Y_STEP_DIS       Y_STEP_EN_PORT &= ~(1 << Y_STEP_EN_BIT)
  #define Z_STEP_EN        Z_STEP_EN_PORT |= (1 << Z_STEP_EN_BIT)
  #define Z_STEP_DIS       Z_STEP_EN_PORT &= ~(1 << Z_STEP_EN_BIT)


  #define STEPPING_EN	X_STEP_EN;Y_STEP_EN;Z_STEP_EN
  #define STEPPING_DIS	X_STEP_DIS;Y_STEP_DIS;Z_STEP_DIS
